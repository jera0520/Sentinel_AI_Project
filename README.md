...
<p align="center">
  <video src="https://github.com/user-attachments/assets/4b88fe60-ece5-45c3-9fcf-3c159c9ad195" width="100%" controls></video>
</p>
...
<p align="center">
  <img src="images/data_preprocessing.jpg" width="80%"/>
  <br>
...
- **변환 작업**
  ...
  - `convert_json_to_yolo.py` 스크립트 개발 및 자동화
...
<p align="center">
  <img src="images/data_problems.jpg" width="80%"/>
  <br>
  <em>1차 학습 데이터의 3가지 주요 문제점</em>
</p>

**문제 1 - 편향된 분포**
- 헬멧 착용: 18,000장 / 노헬멧: 2,000장 (9:1 불균형)

**문제 2 - 환경 불균형**
- 실내: 20,000장 / 실외: 3,899장

**문제 3 - 배경 문제**
- 구조물, 작업도구, 차량이 섞여 AI가 헷갈림

**결과**: mAP 45%, 정확도 60%로 낮은 성능 → 원인 분석 착수
